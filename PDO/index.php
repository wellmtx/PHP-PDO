...
if (isset($_GET['user']) && isset($_GET['password'])) 
{
    ...
    $sql = new sql();
    $exist = $sql->select("SELECT * FROM tb_logins WHERE username = :USERNAME AND userpass= :PASSWORD", array(
        ':USERNAME' => $username,
    ...
    if (count($exist) > 0) 
    {
        ...
        echo "</br></br>";
        echo "<a href=/pdo><button> IR PARA O PAINEL </button></a>";
        echo "</center>";
    } else {
        echo "<center>";
        echo "</br></br>";
        echo "<b>USUÁRIO OU SENHA INCORRETA!</b>";
        echo "</br></br>";
        echo "<a href='/pdo'><button> TENTE NOVAMENTE </button></a>";
        echo "</center>";
    }
}  else if(!$_COOKIE) {

    echo "<center>";
    echo "<span><b> LOGIN </b></span>";
    echo "</br></br></br>";
    echo "<form method='GET'>";
    echo "<span><b>Usuário: </b></span>";
    echo "<input type='text' name='user'>";
    echo "</br></br>";
    echo "<span><b>Password: </b></span>";
